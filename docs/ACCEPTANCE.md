...
8. Carga TXT, DOCX y PDF de prueba. Comprueba cuarentena → limpio y descarga como adjunto. Detén el scanner: el fallo debe bloquear descarga; restáuralo y reintenta una revisión fallida mediante la API indicada abajo. No pruebes malware real.
