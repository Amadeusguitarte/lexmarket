...
export const statusLabels:Record<string,string> = {draft:'Borrador',published:'Recibiendo propuestas',engaged:'En acompañamiento',closed:'Cerrado',requested:'Acceso solicitado',granted:'Acceso autorizado',revoked:'Acceso retirado',pending:'Pendiente',verified:'Verificado',rejected:'Requiere ajustes',quarantine:'Preparando archivo',clean:'Disponible',blocked:'No disponible',failed:'No se pudo procesar',queued:'En cola',working:'Organizando',done:'Terminado',accepted:'Aceptada',declined:'No seleccionada'};
